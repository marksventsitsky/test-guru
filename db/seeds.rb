...
Question.create([
    ...
    { body: 'Какое из следующих условий завершает оператор цикла или оператора switch и передает выполнение оператору сразу после цикла for или switch в Go?', test_id: 1 },
    { body: 'Как создается модель с помощью генератора Rails', test_id: 3 },
    { body: 'Как правильно убрать атрибут title у элемента img?', test_id: 4 },
    { body: 'Какое значение получит а? a = 2,3', test_id: 5 }
                 ])
